...
class ShopTestSuite {
    ...
    @Test
    public void shouldReturnListOfOrdersNoOlderThanTwoYearsSecondWayToCheck() {
        shop.addNewOrder(firstOrder);
        shop.addNewOrder(forthOrder);
        List<Order> listOfOrdersNoOlderThanTwoYears = shop.getListOfOrdersNoOlderThanTwoYears();
    ...
    public void shouldReturnListOfOrdersInGivenRange() {
        ...
        shop.addNewOrder(thirdOrder);
        shop.addNewOrder(forthOrder);
        assertEquals(2, shop.getListOfOrdersInRange(100, 126).size());
    }
